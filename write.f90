module mesh_writer                                       ! === Writer Module ===
  use iso_fortran_env, only: real64                      ! --- Dependencies ---
contains                                                 ! --- Public Routines ---
  subroutine write_mesh(input_path, output_path, count, ids, x, y, z) ! === Node Block Rewriter ===
    ...
    end do ; close(in_unit) ; close(out_unit)                                                     ! Finish up
  end subroutine write_mesh
end module mesh_writer                                      ! === End Writer ===
